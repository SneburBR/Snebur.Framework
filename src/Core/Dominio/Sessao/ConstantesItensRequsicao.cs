...
public static class ConstantesItensRequsicao
{
    ...
    public const string CHAVE_INFORMACAO_SESSAO_ATUAL = "INFORMACAO_SESSAO_ATUAL";
    public const string CHAVE_IDENTIFICADOR_SESSAO_ATUAL = "IDENTIFICADOR_SESSAO_USUARO_ATUAL";
...
//public class InformacaoSessao : InformacaoSessao/*, IIdentificadorSessaoUsuario*/
//{
//    public InformacaoSessao()
//    {
