...
public static class DataHoraUtil
{
    ...
    {
        return SaoIgual(dataHora1, dataHora2, EnumOpcoesCompararData.Data);
    }

    public static bool SaoIgual(DateTime dataHora1, DateTime dataHora2, EnumOpcoesCompararData opcoesData)
    {
    ...
    {
        return SaoIgual(dataHora1, dataHora2, EnumOpcoesCompararData.Data, opcoesHora);
    }

    public static bool SaoIgual(DateTime dataHora1, DateTime dataHora2, EnumOpcoesCompararData opcoesData, OpcoesCompararHora opcoesHora)
    {
        var resultado = true;
