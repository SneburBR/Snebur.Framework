...
public static class TiposComplexExtensao
{
    ...
    {
        return new Thickness(margem.EsquerdaVisualizacao.GetValueOrDefault(),
                             margem.SuperiorVisualizacao.GetValueOrDefault(),
                             margem.DireitaVisualizacao.GetValueOrDefault(),
                             margem.InferiorVisualizacao.GetValueOrDefault());
    }
}
