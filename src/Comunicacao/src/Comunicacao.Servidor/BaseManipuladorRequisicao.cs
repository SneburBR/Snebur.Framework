...
public abstract partial class BaseManipuladorRequisicao
{
    ...
    private Dictionary<string, Type> TiposManipuladores
        => LazyUtil.RetornarValorLazyComBloqueio(ref field, this.RetornarTiposManipuladores);
    ...
    public void NotificarServicoNaoEncontado(HttpContext httpContext,
                                             string? nomeServico)
    {
        LogUtil.SegurancaAsync(nomeServico ?? "null", EnumTipoLogSeguranca.ServicoNaoEncontrado);
