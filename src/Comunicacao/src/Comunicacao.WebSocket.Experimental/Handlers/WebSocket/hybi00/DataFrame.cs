...
namespace Snebur.Comunicacao.WebSocket.Experimental.Handlers.WebSocket.hybi00
{
    /// <summary>
    ...
    public class DataFrame : WebSocket.DataFrame
    {
        ...
        /// /// <param name="asFrame">For internal Snebur.Comunicacao.WebSocket.Experimental use.</param>
