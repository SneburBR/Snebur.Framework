...
namespace Snebur.ServicoArquivo
{
                                                                                                                                                                                         ...
                                                                                                                                                                                         where TInformacaoReposotiroArquivo : IInformacaoRepositorioArquivo
    {
        ...
        private void SalvarArquivoTempoariario(ZyonHttpContext httpContext, long idArquivo, TCabecalhoServicoArquivo cabecalho)
        {
            ...
            var pacote = this.RetornarInputStream(httpContext);
