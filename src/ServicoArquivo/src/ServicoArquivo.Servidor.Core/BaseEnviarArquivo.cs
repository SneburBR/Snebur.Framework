...
namespace Snebur.ServicoArquivo
{
                                                                                                                                                                                         ...
                                                                                                                                                                                         where TInformacaoReposotiroArquivo : IInformacaoRepositorioArquivo
    {
        ...
        {
            this.SalvarArquivo(context, cabecalho);
        }

        protected override TCabecalhoServicoArquivo RetornarCabecalhoServicoArquivo(ZyonHttpContext httpContext)
        {
        ...
        protected virtual void SalvarArquivo(ZyonHttpContext httpContext, TCabecalhoServicoArquivo cabecalho)
        {
            ...
            this.SalvarArquivoTempoariario(httpContext, idArquivo, cabecalho);
        }
