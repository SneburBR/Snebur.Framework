                                                                                                                                                                                     ...
                                                                                                                                                                                     where TInformacaoReposotiroArquivo : IInformacaoRepositorioArquivo
{
    ...
    {
        return (TCabecalhoServicoArquivo)new CabecalhoServicoArquivo(httpContext, true);
    }
    ...
    protected virtual void SalvarArquivo(HttpContext httpContext, TCabecalhoServicoArquivo cabecalho, MemoryStream inputStreasm)
    {
        ...
        {
            if (this.ServicoArquivoCliente.ExisteIdArquivo(idArquivo) == false)
            {
    ...
    private void FinalizarEnvioArquivo(TCabecalhoServicoArquivo cabecalho,
        long idArquivo,
        string caminhoCompletoStream,
        string? checksum,
        long totalBytesCliente)
    {
