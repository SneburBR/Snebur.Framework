...
public partial class ConsultaEntidade<TEntidade> where TEntidade : IEntidade
{
    ...
    private void AdicionarFiltro(EstruturaConsulta estruturaConsulta,
        Expression? expressao,
        BaseFiltroGrupo grupoFiltroAtual)
    {
                ...
                case ExpressionType.Call:
                    {
                        ...
                        switch (expressaoMetodo.Method.Name)
                        {
                            ...
                            case "Equals":
                                ...
                                var filtroPropriedadeMetodo = AjudanteFiltroPropriedade.RetornarFiltroPropriedadeMetodo(estruturaConsulta, expressaoMetodo, comparacao);
