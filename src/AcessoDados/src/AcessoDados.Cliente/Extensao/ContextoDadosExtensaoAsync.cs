...
{
    public static Task SalvarPropriedadesAsync<TEntidade>(
        this BaseContextoDados contexto,
        TEntidade entidade,
        params Expression<Func<TEntidade, object?>>[] expressoesPropriedade)
    ...
    public static Task RecuperarPropriedadeAsync<TEntidade>(
        this BaseContextoDados contexto,
    ...
    public static Task RecuperarPropriedadesAsync<TEntidade>(
        this BaseContextoDados contexto, 
        List<TEntidade> entidades, 
        params Expression<Func<TEntidade, object?>>[] expressoesPropriedade)
        where TEntidade : Entidade
    ...
    public static Task AbrirRelacaoAsync<TEntidade, TRelacao>(
        this BaseContextoDados contexto, 
        TEntidade entidade, 
        Expression<Func<TEntidade, TRelacao?>> expressaoRelacao)
    ...
    public static Task AbrirRelacoesAsync<TEntidade, TRelacao>(
        this BaseContextoDados contexto, 
        TEntidade entidade, 
        params Expression<Func<TEntidade, TRelacao?>>[] expressoesRelacao) 
        where TEntidade : Entidade 
