...
namespace Snebur.AcessoDados.Manutencao
{
    ...
    {
        protected ContextoDados Contexto { get; }
        ...
        public BaseManutencao(ContextoDados contexto)
        {
    ...
    public abstract class BaseManutencao<TContexto> : BaseManutencao where TContexto : ContextoDados
    {
