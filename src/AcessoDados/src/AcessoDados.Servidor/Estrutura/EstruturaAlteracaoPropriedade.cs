...
internal class BaseEstruturaAlteracaoPropriedade<TAtributo> : EstruturaPropriedade, IEstruturaAlteracaoPropriedade where TAtributo : INotificarAlteracaoPropriedade
{
    ...
    [MemberNotNullWhen(true, nameof(EstruturaTipoComplexo))]
    [MemberNotNullWhen(false, nameof(EstruturaCampo))]
    ...
    public bool IsNotificarNovoCadastro
        => (this.Atributo.Opcoes & EnumOpcoesAlterarPropriedade.NotificarNovoCadastro) == EnumOpcoesAlterarPropriedade.NotificarNovoCadastro;
    public bool IsVerificarAlteracaoBanco
        => (this.Atributo.Opcoes & EnumOpcoesAlterarPropriedade.VerificarAlteracaoNoBanco) == EnumOpcoesAlterarPropriedade.VerificarAlteracaoNoBanco;
    public bool IsSalvarDataHoraFimAlteracao
        => (this.Atributo.Opcoes & EnumOpcoesAlterarPropriedade.AtualizarDataHoraFimAlteracao) == EnumOpcoesAlterarPropriedade.AtualizarDataHoraFimAlteracao;
    public bool IsIgnorarZeroIgualNull
        => (this.Atributo.Opcoes & EnumOpcoesAlterarPropriedade.IgnorarZeroIgualNull) == EnumOpcoesAlterarPropriedade.IgnorarZeroIgualNull;
    public bool IsIgnorarValorAntigoNull
        => (this.Atributo.Opcoes & EnumOpcoesAlterarPropriedade.IgnorarValorAntigoNull) == EnumOpcoesAlterarPropriedade.IgnorarValorAntigoNull;
    public bool IsProteger
        => (this.Atributo.Opcoes & EnumOpcoesAlterarPropriedade.Proteger) == EnumOpcoesAlterarPropriedade.Proteger;

    internal BaseEstruturaAlteracaoPropriedade(
