...
namespace Snebur.AcessoDados
{
    ...
    {
        public static void SalvarPropriedade<TEntidade>(this __BaseContextoDados contexto,
                                                       TEntidade entidade,
        ...
        public static void SalvarPropriedades<TEntidade>(this __BaseContextoDados contexto,
                                                          TEntidade entidade,
        ...
        public static void RecuperarPropriedade<TEntidade>(this __BaseContextoDados contexto,
                                                          TEntidade entidade,
        ...
        public static void RecuperarPropriedades<TEntidade>(this __BaseContextoDados contexto,
                                                            TEntidade entidade,
                                                            params Expression<Func<TEntidade, object>>[] expressoesPropriedade) where TEntidade : Entidade
        {
            RecuperarPropriedades(contexto,
        ...
        public static void AbrirRelacao<TEntidade>(this __BaseContextoDados contexto, TEntidade entidade, Expression<Func<TEntidade, object>> expressaoRelacao) where TEntidade : Entidade
        {
            AbrirRelacoes(contexto, entidade, expressaoRelacao);
        }

        public static void AbrirRelacoes<TEntidade>(this __BaseContextoDados contexto,
                                                    TEntidade entidade,
