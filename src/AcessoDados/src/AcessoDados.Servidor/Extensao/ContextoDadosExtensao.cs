...
//        public static void AbrirRelacao<TEntidade>(this IContextoDados contexto, TEntidade entidade, Expression<Func<TEntidade, object>> expressaoRelacao) where TEntidade : Entidade
//        {
//            AbrirRelacoes(contexto, entidade, expressaoRelacao);
//        }

//        public static void AbrirRelacoes<TEntidade>(this IContextoDados contexto,
//                                                    TEntidade entidade,
...
//        public static void AbrirColecoes<TEntidade>(this IContextoDados contexto, TEntidade entidade, params Expression<Func<TEntidade, IEnumerable>>[] expressoesColecao) where TEntidade : Entidade
//        {
//            var entidadeRecuperada = contexto.RetornarConsulta<TEntidade>(entidade.GetType()).
//                                              Where(x => x.Id == entidade.Id).
