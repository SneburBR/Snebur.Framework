...
namespace Snebur.AcessoDados
{
    ...
    {
        public static void SalvarPropriedade<TEntidade>(this BaseContextoDados contexto,
                                                       TEntidade entidade,
        ...
        public static void SalvarPropriedades<TEntidade>(this BaseContextoDados contexto,
                                                          TEntidade entidade,
        ...
        public static void RecuperarPropriedade<TEntidade>(this BaseContextoDados contexto,
                                                          TEntidade entidade,
        ...
        public static void RecuperarPropriedades<TEntidade>(this BaseContextoDados contexto,
                                                            TEntidade entidade,
                                                            params Expression<Func<TEntidade, object>>[] expressoesPropriedade) where TEntidade : Entidade
        {
            RecuperarPropriedades(contexto,
        ...
        public static void AbrirRelacao<TEntidade>(this BaseContextoDados contexto, TEntidade entidade, Expression<Func<TEntidade, object>> expressaoRelacao) where TEntidade : Entidade
        {
            AbrirRelacoes(contexto, entidade, expressaoRelacao);
        }

        public static void AbrirRelacoes<TEntidade>(this BaseContextoDados contexto,
                                                    TEntidade entidade,
        ...
        public static void AbrirColecoes<TEntidade>(this BaseContextoDados contexto, TEntidade entidade, params Expression<Func<TEntidade, IEnumerable>>[] expressoesColecao) where TEntidade : Entidade
        {
            var entidadeRecuperada = contexto.RetornarConsulta<TEntidade>(entidade.GetType()).
                                              Where(x => x.Id == entidade.Id).
