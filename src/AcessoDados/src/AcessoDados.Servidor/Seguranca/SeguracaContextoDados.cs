...
internal partial class SeguracaContextoDados
{
    ...
    private SeguracaContextoDados(IContextoDadosSeguranca contexto)
    {
        ...
        Guard.NotNull(contexto.TiposSeguranca.TipoPermissaoEntidade);
    ...
    internal EnumPermissao PermissaoLeitura(
        IUsuario usuario,
    ...
    {
        Guard.NotNull(this.ContextoDados.TiposSeguranca.TipoUsuario);
