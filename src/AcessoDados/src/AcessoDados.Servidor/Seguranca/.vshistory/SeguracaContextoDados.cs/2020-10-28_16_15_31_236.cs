...
namespace Snebur.AcessoDados.Seguranca
{
    internal partial class SeguracaContextoDados
    {
        ...
        private SeguracaContextoDados(IContextoDadosSeguranca contexto)
        {
            ...
            this.EstruturaBancoDados = (contexto as ContextoDados).EstruturaBancoDados;
            ...
            var resultadoConsulta = (contexto as ContextoDados).RetornarResultadoConsultaInterno(consultaPermissoesEntidade.EstruturaConsulta);
