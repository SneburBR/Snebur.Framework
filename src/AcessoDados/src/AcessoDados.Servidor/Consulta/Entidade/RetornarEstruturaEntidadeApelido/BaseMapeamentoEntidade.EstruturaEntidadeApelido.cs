...
internal abstract partial class BaseMapeamentoEntidade
{
        ...
        EstruturaCampoApelido? estruturaCampoChaveEstrangeiraApelido = null)
    {
        ...
        else
        {
            ...
            estruturaEntidadeMapeadaBase.EstruturaCampoApelidoChavePrimaria = this.RetornarEstruturaCampoApelido(estruturaCampoChavePrimaria,
                caminhoPropriedadeParcial,
                estruturaEntidadeMapeadaBase);
        ...
        EstruturaCampoApelido? estruturaCampoChaveEstrangeiraMapeado)
    {
        ...
        {
            Guard.NotNull(estruturaCampoChaveEstrangeiraMapeado);
