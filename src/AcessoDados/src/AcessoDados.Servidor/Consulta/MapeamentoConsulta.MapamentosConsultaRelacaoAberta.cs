...
internal partial class MapeamentoConsulta
{
    internal void MontarMapamentosConsultaRelacaoAberta()
    {
        ...
        foreach (var relacaoAberta in this.EstruturaConsulta.RetornarTodasRelacoesAberta())
        {
            ...
            Guard.NotNull(caminhoPropriedade);
                                                                                       ...
                                                                                       BaseRelacaoAberta relacaoAberta)
    {
        ...
        Guard.NotNull(estruturaRelacao);
    ...
    {
        if (relacaoAberta is RelacaoAbertaColecao relacaoAbertaColecao)
        {
            Guard.NotNull(relacaoAbertaColecao.EstruturaConsulta);
            return relacaoAbertaColecao.EstruturaConsulta;
        }
        else
        {
