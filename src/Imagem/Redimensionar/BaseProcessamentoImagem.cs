...
public abstract class BaseProcessarImagem : IDisposable
{
    ...
    public BaseProcessarImagem(string caminhoArquivo,
        int comprimentoMaximo, EnumLadoComprimento lado, double Dpi, bool converterPerfilOrigem)
    {
    ...
    private Size RetornarTamanhoRedimensioanr()
    {
        switch (this.OpcaoRedimensionar)
        {
            ...
            case EnumOpcaoRedimensionar.Uniforme:
                ...
                return ImagemUtil.RetornarTamanhoUniforme(
                    this.LarguraImagemOriginal,
                    this.AlturaImagemOriginal,
                    this.Tamanho.Width,
                    this.Tamanho.Height);

            case EnumOpcaoRedimensionar.UniformeParaPrencher:

                return ImagemUtil.RetornarTamanhoUniformeParaPreencher(
                    this.LarguraImagemOriginal,
                    this.AlturaImagemOriginal,
                    this.Tamanho.Width,
                    this.Tamanho.Height);
            ...
            case EnumOpcaoRedimensionar.AjustarUniforme:
                ...
                return ImagemUtil.RetornarTamanhoUniforme(
                    this.LarguraImagemOriginal,
                    this.AlturaImagemOriginal,
                    tamanhoAjustado.Width,
                    tamanhoAjustado.Height);
            ...
            case EnumOpcaoRedimensionar.AjustarUniformeParaPrencher:
                ...
                return ImagemUtil.RetornarTamanhoUniformeParaPreencher(
                    this.LarguraImagemOriginal,
                    this.AlturaImagemOriginal,
                    tamanhoAjustado2.Width,
                    tamanhoAjustado2.Height);
    ...
    {
        var diretorio = Path.GetDirectoryName(caminhoArquivoDestino);
        Guard.NotNullOrWhiteSpace(diretorio);
        var caminhoTemp = CaminhoUtil.RetornarCaminhoArquivoTemporario(diretorio);
        try
        {
