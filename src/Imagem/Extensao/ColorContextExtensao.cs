...
public static class ColorContextExtensao
{
    ...
    {
        var profileHeader = typeof(ColorContext).GetField("_profileHeader", BindingFlags.Instance | BindingFlags.NonPublic)?.GetValue(colorContext);
        if (profileHeader != null)
        {
            var tamanho = profileHeader.GetType().GetField("phSize", BindingFlags.Instance | BindingFlags.Public)?.GetValue(profileHeader);
    ...
    {
        var colorSpace = typeof(ColorContext).GetProperty("ColorSpaceFamily", BindingFlags.Instance | BindingFlags.NonPublic)?.GetValue(colorContext);

        Guard.NotNull(colorSpace);
