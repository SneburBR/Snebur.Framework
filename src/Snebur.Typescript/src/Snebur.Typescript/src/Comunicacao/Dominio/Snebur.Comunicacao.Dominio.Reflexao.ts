...
namespace Snebur.Reflexao
{
	...
	//BaseDominio
	export const __$tipoBaseDominioSnebur_Comunicacao_BaseComunicao = new Snebur.Reflexao.TipoBaseDominio(Snebur.Comunicacao.BaseComunicao, "BaseComunicao", "Snebur.Comunicacao","Snebur.Comunicacao.BaseComunicao, Snebur.Comunicacao",__$tipoBaseDominioSnebur_Dominio_BaseDominio, false);
	export const __$tipoBaseDominioSnebur_Comunicacao_Cabecalho = new Snebur.Reflexao.TipoBaseDominio(Snebur.Comunicacao.Cabecalho, "Cabecalho", "Snebur.Comunicacao","Snebur.Comunicacao.Cabecalho, Snebur.Comunicacao",__$tipoBaseDominioSnebur_Comunicacao_BaseComunicao, false);
	export const __$tipoBaseDominioSnebur_Comunicacao_ContratoChamada = new Snebur.Reflexao.TipoBaseDominio(Snebur.Comunicacao.ContratoChamada, "ContratoChamada", "Snebur.Comunicacao","Snebur.Comunicacao.ContratoChamada, Snebur.Comunicacao",__$tipoBaseDominioSnebur_Comunicacao_BaseComunicao, false);
	export const __$tipoBaseDominioSnebur_Comunicacao_ParametroChamada = new Snebur.Reflexao.TipoBaseDominio(Snebur.Comunicacao.ParametroChamada, "ParametroChamada", "Snebur.Comunicacao","Snebur.Comunicacao.ParametroChamada, Snebur.Comunicacao",__$tipoBaseDominioSnebur_Comunicacao_BaseComunicao, true);
	export const __$tipoBaseDominioSnebur_Comunicacao_ChamadaRegraNegocio = new Snebur.Reflexao.TipoBaseDominio(Snebur.Comunicacao.ChamadaRegraNegocio, "ChamadaRegraNegocio", "Snebur.Comunicacao","Snebur.Comunicacao.ChamadaRegraNegocio, Snebur.Comunicacao",__$tipoBaseDominioSnebur_Comunicacao_BaseComunicao, false);
	export const __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamada = new Snebur.Reflexao.TipoBaseDominio(Snebur.Comunicacao.ResultadoChamada, "ResultadoChamada", "Snebur.Comunicacao","Snebur.Comunicacao.ResultadoChamada, Snebur.Comunicacao",__$tipoBaseDominioSnebur_Comunicacao_BaseComunicao, true);
	...
	//ListaBaseDominio
	export const __$tipoListaBaseDominio_Snebur_Comunicacao_BaseComunicao = new Snebur.Reflexao.TipoListaBaseDominio("ListaTipoBaseDominio_BaseComunicao", "Snebur.Comunicacao", "System.Collections.Generic.List`1[[Snebur.Comunicacao.BaseComunicao, Snebur.Comunicacao]], mscorlib",__$tipoBaseDominioSnebur_Comunicacao_BaseComunicao);
	export const __$tipoListaBaseDominio_Snebur_Comunicacao_Cabecalho = new Snebur.Reflexao.TipoListaBaseDominio("ListaTipoBaseDominio_Cabecalho", "Snebur.Comunicacao", "System.Collections.Generic.List`1[[Snebur.Comunicacao.Cabecalho, Snebur.Comunicacao]], mscorlib",__$tipoBaseDominioSnebur_Comunicacao_Cabecalho);
	export const __$tipoListaBaseDominio_Snebur_Comunicacao_ContratoChamada = new Snebur.Reflexao.TipoListaBaseDominio("ListaTipoBaseDominio_ContratoChamada", "Snebur.Comunicacao", "System.Collections.Generic.List`1[[Snebur.Comunicacao.ContratoChamada, Snebur.Comunicacao]], mscorlib",__$tipoBaseDominioSnebur_Comunicacao_ContratoChamada);
	export const __$tipoListaBaseDominio_Snebur_Comunicacao_ParametroChamada = new Snebur.Reflexao.TipoListaBaseDominio("ListaTipoBaseDominio_ParametroChamada", "Snebur.Comunicacao", "System.Collections.Generic.List`1[[Snebur.Comunicacao.ParametroChamada, Snebur.Comunicacao]], mscorlib",__$tipoBaseDominioSnebur_Comunicacao_ParametroChamada);
	export const __$tipoListaBaseDominio_Snebur_Comunicacao_ChamadaRegraNegocio = new Snebur.Reflexao.TipoListaBaseDominio("ListaTipoBaseDominio_ChamadaRegraNegocio", "Snebur.Comunicacao", "System.Collections.Generic.List`1[[Snebur.Comunicacao.ChamadaRegraNegocio, Snebur.Comunicacao]], mscorlib",__$tipoBaseDominioSnebur_Comunicacao_ChamadaRegraNegocio);
	export const __$tipoListaBaseDominio_Snebur_Comunicacao_ResultadoChamada = new Snebur.Reflexao.TipoListaBaseDominio("ListaTipoBaseDominio_ResultadoChamada", "Snebur.Comunicacao", "System.Collections.Generic.List`1[[Snebur.Comunicacao.ResultadoChamada, Snebur.Comunicacao]], mscorlib",__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamada);
	...
	$Reflexao.Tipos.Adicionar("Snebur.Comunicacao.BaseComunicao",__$tipoBaseDominioSnebur_Comunicacao_BaseComunicao);
	$Reflexao.Tipos.Adicionar("Snebur.Comunicacao.Cabecalho",__$tipoBaseDominioSnebur_Comunicacao_Cabecalho);
	$Reflexao.Tipos.Adicionar("Snebur.Comunicacao.ContratoChamada",__$tipoBaseDominioSnebur_Comunicacao_ContratoChamada);
	$Reflexao.Tipos.Adicionar("Snebur.Comunicacao.ParametroChamada",__$tipoBaseDominioSnebur_Comunicacao_ParametroChamada);
	$Reflexao.Tipos.Adicionar("Snebur.Comunicacao.ChamadaRegraNegocio",__$tipoBaseDominioSnebur_Comunicacao_ChamadaRegraNegocio);
	$Reflexao.Tipos.Adicionar("Snebur.Comunicacao.ResultadoChamada",__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamada);
	...
	$Reflexao.Tipos.Adicionar("ListaTipoBaseDominio_Snebur.Comunicacao.BaseComunicao",__$tipoListaBaseDominio_Snebur_Comunicacao_BaseComunicao);
	$Reflexao.Tipos.Adicionar("ListaTipoBaseDominio_Snebur.Comunicacao.Cabecalho",__$tipoListaBaseDominio_Snebur_Comunicacao_Cabecalho);
	$Reflexao.Tipos.Adicionar("ListaTipoBaseDominio_Snebur.Comunicacao.ContratoChamada",__$tipoListaBaseDominio_Snebur_Comunicacao_ContratoChamada);
	$Reflexao.Tipos.Adicionar("ListaTipoBaseDominio_Snebur.Comunicacao.ParametroChamada",__$tipoListaBaseDominio_Snebur_Comunicacao_ParametroChamada);
	$Reflexao.Tipos.Adicionar("ListaTipoBaseDominio_Snebur.Comunicacao.ChamadaRegraNegocio",__$tipoListaBaseDominio_Snebur_Comunicacao_ChamadaRegraNegocio);
	$Reflexao.Tipos.Adicionar("ListaTipoBaseDominio_Snebur.Comunicacao.ResultadoChamada",__$tipoListaBaseDominio_Snebur_Comunicacao_ResultadoChamada);
	...
	Snebur.Comunicacao.BaseComunicao.__CaminhoTipo = "Snebur.Comunicacao.BaseComunicao";
	Snebur.Comunicacao.Cabecalho.__CaminhoTipo = "Snebur.Comunicacao.Cabecalho";
	Snebur.Comunicacao.ContratoChamada.__CaminhoTipo = "Snebur.Comunicacao.ContratoChamada";
	Snebur.Comunicacao.ParametroChamada.__CaminhoTipo = "Snebur.Comunicacao.ParametroChamada";
	Snebur.Comunicacao.ChamadaRegraNegocio.__CaminhoTipo = "Snebur.Comunicacao.ChamadaRegraNegocio";
	Snebur.Comunicacao.ResultadoChamada.__CaminhoTipo = "Snebur.Comunicacao.ResultadoChamada";
	...
	export const __$propriedade_Snebur_Comunicacao_Cabecalho_CredencialAvalista = new Snebur.Reflexao.Propriedade("CredencialAvalista", __$tipoBaseDominioSnebur_Seguranca_CredencialUsuario, __$tipoBaseDominioSnebur_Comunicacao_Cabecalho, true);
	...
	__$tipoBaseDominioSnebur_Comunicacao_Cabecalho.Propriedades.Add(__$propriedade_Snebur_Comunicacao_Cabecalho_UrlOrigem);
	...
	export const __$propriedade_Snebur_Comunicacao_ContratoChamada_DataHora = new Snebur.Reflexao.Propriedade("DataHora", __$tipoTipoPrimario_DateTime, __$tipoBaseDominioSnebur_Comunicacao_ContratoChamada, false);
	
	export const __$propriedade_Snebur_Comunicacao_ContratoChamada_Async = new Snebur.Reflexao.Propriedade("Async", __$tipoTipoPrimario_Boolean, __$tipoBaseDominioSnebur_Comunicacao_ContratoChamada, false);
	...
	__$tipoBaseDominioSnebur_Comunicacao_ContratoChamada.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ContratoChamada_Parametros);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamada_Nome = new Snebur.Reflexao.Propriedade("Nome", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamada, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamada_NomeTipoParametro = new Snebur.Reflexao.Propriedade("NomeTipoParametro", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamada, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamada_AssemblyQualifiedName = new Snebur.Reflexao.Propriedade("AssemblyQualifiedName", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamada, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamada.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamada_Nome);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamada.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamada_NomeTipoParametro);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamada.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamada_AssemblyQualifiedName);
	
	export const __$propriedade_Snebur_Comunicacao_ChamadaRegraNegocio_AssemblyQualifiedName = new Snebur.Reflexao.Propriedade("AssemblyQualifiedName", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ChamadaRegraNegocio, true);
	
	export const __$propriedade_Snebur_Comunicacao_ChamadaRegraNegocio_NomeMetodo = new Snebur.Reflexao.Propriedade("NomeMetodo", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ChamadaRegraNegocio, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ChamadaRegraNegocio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ChamadaRegraNegocio_AssemblyQualifiedName);
	__$tipoBaseDominioSnebur_Comunicacao_ChamadaRegraNegocio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ChamadaRegraNegocio_NomeMetodo);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamada_NomeServico = new Snebur.Reflexao.Propriedade("NomeServico", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamada, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamada_DataHora = new Snebur.Reflexao.Propriedade("DataHora", __$tipoTipoPrimario_DateTime, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamada, false);
	...
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamada_TempoOperacao = new Snebur.Reflexao.Propriedade("TempoOperacao", __$tipoTipoPrimario_Integer, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamada, false);
	...
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamada.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamada_TempoOperacao);
	...
	__$propriedade_Snebur_Comunicacao_ConfiguracaoServicoImagem_UrlVisualizarImagem.Atributos.Add(new Snebur.Dominio.Atributos.ValidacaoRequeridoAttribute());
	...
	export const __$propriedade_Snebur_Comunicacao_ResultadoExcluir_IsSucesso = new Snebur.Reflexao.Propriedade("IsSucesso", __$tipoTipoPrimario_Boolean, __$tipoBaseDominioSnebur_Comunicacao_ResultadoExcluir, false);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoExcluir_MensagemErro = new Snebur.Reflexao.Propriedade("MensagemErro", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoExcluir, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoExcluir.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoExcluir_IsSucesso);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoExcluir.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoExcluir_MensagemErro);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaBaseDominio_BaseDominio = new Snebur.Reflexao.Propriedade("BaseDominio", __$tipoBaseDominioSnebur_Dominio_BaseDominio, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaBaseDominio, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaBaseDominio_BaseDominio);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaEnum_NomeTipoEnum = new Snebur.Reflexao.Propriedade("NomeTipoEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaEnum_NamespaceEnum = new Snebur.Reflexao.Propriedade("NamespaceEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaEnum_Valor = new Snebur.Reflexao.Propriedade("Valor", __$tipoTipoPrimario_Integer, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaEnum, false);
	
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaEnum_NomeTipoEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaEnum_NamespaceEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaEnum_Valor);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaTipoPrimario_Valor = new Snebur.Reflexao.Propriedade("Valor", __$tipoTipoPrimario_Object, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaTipoPrimario, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaTipoPrimario_TipoPrimarioEnum = new Snebur.Reflexao.Propriedade("TipoPrimarioEnum", __$tipoEnum_Snebur_Reflexao_EnumTipoPrimario, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaTipoPrimario, false);
	
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaTipoPrimario_Valor);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaTipoPrimario_TipoPrimarioEnum);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaBaseDominio_NomeTipoBaseDominio = new Snebur.Reflexao.Propriedade("NomeTipoBaseDominio", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaBaseDominio, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaBaseDominio_NomeNamespaceTipoBaseDominio = new Snebur.Reflexao.Propriedade("NomeNamespaceTipoBaseDominio", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaBaseDominio, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaBaseDominio_BasesDominio = new Snebur.Reflexao.Propriedade("BasesDominio", __$tipoListaBaseDominio_Snebur_Dominio_BaseDominio, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaBaseDominio, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaBaseDominio_NomeTipoBaseDominio);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaBaseDominio_NomeNamespaceTipoBaseDominio);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaBaseDominio_BasesDominio);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaEnum_NomeTipoEnum = new Snebur.Reflexao.Propriedade("NomeTipoEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaEnum_NamespaceEnum = new Snebur.Reflexao.Propriedade("NamespaceEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaEnum_Valores = new Snebur.Reflexao.Propriedade("Valores", __$tipoListaTipoPrimario_Integer, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaEnum, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaEnum_NomeTipoEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaEnum_NamespaceEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaEnum_Valores);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaTipoPrimario_Lista = new Snebur.Reflexao.Propriedade("Lista", __$tipoListaTipoPrimario_Object, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaTipoPrimario, true);
	
	export const __$propriedade_Snebur_Comunicacao_ParametroChamadaListaTipoPrimario_TipoPrimarioEnum = new Snebur.Reflexao.Propriedade("TipoPrimarioEnum", __$tipoEnum_Snebur_Reflexao_EnumTipoPrimario, __$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaTipoPrimario, false);
	
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaTipoPrimario_Lista);
	__$tipoBaseDominioSnebur_Comunicacao_ParametroChamadaListaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ParametroChamadaListaTipoPrimario_TipoPrimarioEnum);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaBaseDominio_BaseDominio = new Snebur.Reflexao.Propriedade("BaseDominio", __$tipoBaseDominioSnebur_Dominio_BaseDominio, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaBaseDominio, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaBaseDominio_BaseDominio);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaEnum_NomeTipoEnum = new Snebur.Reflexao.Propriedade("NomeTipoEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaEnum_NamespaceEnum = new Snebur.Reflexao.Propriedade("NamespaceEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaEnum_Valor = new Snebur.Reflexao.Propriedade("Valor", __$tipoTipoPrimario_Integer, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaEnum, false);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaEnum_NomeTipoEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaEnum_NamespaceEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaEnum_Valor);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaErro_MensagemErro = new Snebur.Reflexao.Propriedade("MensagemErro", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaErro, true);
	...
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaLista.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaLista_AssemblyQualifiedName);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaTipoPrimario_Valor = new Snebur.Reflexao.Propriedade("Valor", __$tipoTipoPrimario_Object, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaTipoPrimario, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaTipoPrimario_TipoPrimarioEnum = new Snebur.Reflexao.Propriedade("TipoPrimarioEnum", __$tipoEnum_Snebur_Reflexao_EnumTipoPrimario, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaTipoPrimario, false);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaTipoPrimario_Valor);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaTipoPrimario_TipoPrimarioEnum);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaBaseDominio_NomeTipoBaseDominio = new Snebur.Reflexao.Propriedade("NomeTipoBaseDominio", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaBaseDominio, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaBaseDominio_NomeNamespaceTipoBaseDominio = new Snebur.Reflexao.Propriedade("NomeNamespaceTipoBaseDominio", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaBaseDominio, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaBaseDominio_BasesDominio = new Snebur.Reflexao.Propriedade("BasesDominio", __$tipoListaBaseDominio_Snebur_Dominio_BaseDominio, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaBaseDominio, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaBaseDominio_NomeTipoBaseDominio);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaBaseDominio_NomeNamespaceTipoBaseDominio);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaBaseDominio.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaBaseDominio_BasesDominio);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaEnum_NomeTipoEnum = new Snebur.Reflexao.Propriedade("NomeTipoEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaEnum_NamespaceEnum = new Snebur.Reflexao.Propriedade("NamespaceEnum", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaEnum, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaEnum_Valores = new Snebur.Reflexao.Propriedade("Valores", __$tipoListaTipoPrimario_Integer, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaEnum, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaEnum_NomeTipoEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaEnum_NamespaceEnum);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaEnum.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaEnum_Valores);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaTipoPrimario_Valores = new Snebur.Reflexao.Propriedade("Valores", __$tipoListaTipoPrimario_Object, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaTipoPrimario, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoChamadaListaTipoPrimario_TipoPrimarioEnum = new Snebur.Reflexao.Propriedade("TipoPrimarioEnum", __$tipoEnum_Snebur_Reflexao_EnumTipoPrimario, __$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaTipoPrimario, false);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaTipoPrimario_Valores);
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoChamadaListaTipoPrimario.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoChamadaListaTipoPrimario_TipoPrimarioEnum);
	
	export const __$propriedade_Snebur_Comunicacao_DominioGlobalizacao_NamespaceGlobalizacao = new Snebur.Reflexao.Propriedade("NamespaceGlobalizacao", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_DominioGlobalizacao, true);
	
	export const __$propriedade_Snebur_Comunicacao_DominioGlobalizacao_JsonBase54 = new Snebur.Reflexao.Propriedade("JsonBase54", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_DominioGlobalizacao, true);
	...
	export const __$propriedade_Snebur_Comunicacao_ResultadoGlobalizacao_Dominios = new Snebur.Reflexao.Propriedade("Dominios", __$tipoListaBaseDominio_Snebur_Comunicacao_DominioGlobalizacao, __$tipoBaseDominioSnebur_Comunicacao_ResultadoGlobalizacao, true);
	
	export const __$propriedade_Snebur_Comunicacao_ResultadoGlobalizacao_Telas = new Snebur.Reflexao.Propriedade("Telas", __$tipoListaBaseDominio_Snebur_Comunicacao_TelaGlobalizacao, __$tipoBaseDominioSnebur_Comunicacao_ResultadoGlobalizacao, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_ResultadoGlobalizacao.Propriedades.Add(__$propriedade_Snebur_Comunicacao_ResultadoGlobalizacao_JsonIdiomaBase64);
	...
	export const __$propriedade_Snebur_Comunicacao_Mensageiro_ContratoMensageiro_Destinatario = new Snebur.Reflexao.Propriedade("Destinatario", __$tipoBaseDominioSnebur_Dominio_BaseDominio, __$tipoBaseDominioSnebur_Comunicacao_Mensageiro_ContratoMensageiro, true);
	
	export const __$propriedade_Snebur_Comunicacao_Mensageiro_ContratoMensageiro_NomeRecurso = new Snebur.Reflexao.Propriedade("NomeRecurso", __$tipoTipoPrimario_String, __$tipoBaseDominioSnebur_Comunicacao_Mensageiro_ContratoMensageiro, true);
	
	export const __$propriedade_Snebur_Comunicacao_Mensageiro_ContratoMensageiro_ValorParametro = new Snebur.Reflexao.Propriedade("ValorParametro", __$tipoBaseDominioSnebur_Dominio_BaseDominio, __$tipoBaseDominioSnebur_Comunicacao_Mensageiro_ContratoMensageiro, true);
	
	__$tipoBaseDominioSnebur_Comunicacao_Mensageiro_ContratoMensageiro.Propriedades.Add(__$propriedade_Snebur_Comunicacao_Mensageiro_ContratoMensageiro_Remetente);
	__$tipoBaseDominioSnebur_Comunicacao_Mensageiro_ContratoMensageiro.Propriedades.Add(__$propriedade_Snebur_Comunicacao_Mensageiro_ContratoMensageiro_Destinatario);
	__$tipoBaseDominioSnebur_Comunicacao_Mensageiro_ContratoMensageiro.Propriedades.Add(__$propriedade_Snebur_Comunicacao_Mensageiro_ContratoMensageiro_NomeRecurso);
	__$tipoBaseDominioSnebur_Comunicacao_Mensageiro_ContratoMensageiro.Propriedades.Add(__$propriedade_Snebur_Comunicacao_Mensageiro_ContratoMensageiro_ValorParametro);
